...
def footer(description, cities):
    ...
    return (
        ...
        '<a href="https://www.instagram.com/kibleyonuhesapla/" target="_blank" '
        'rel="noopener noreferrer" aria-label="Kıble Yönü Hesapla Instagram profili">'
        ...
        '<span class="sr-only">Instagram</span></a></nav></div>\n'
